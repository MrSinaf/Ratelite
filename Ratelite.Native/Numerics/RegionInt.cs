...
public struct RegionInt(Vector2Int position00, Vector2Int position11)
		: ILerpable<RegionInt>, IEquatable<RegionInt>
{
	...
	public RegionInt(int x, int y, int z, int w) : this(
		new Vector2Int(x, y),
		new Vector2Int(z, w)
	) { }
	...
	bool IEquatable<RegionInt>.Equals(RegionInt other)
	...
	public static RegionInt operator *(RegionInt m, int scalar)
		=> new (m.position00 * scalar, m.position11 * scalar);

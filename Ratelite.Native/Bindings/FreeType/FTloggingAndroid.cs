...
{
    internal unsafe class FTloggingAndroid : IFTlogging
    {
        public void FT_Trace_Set_Level(byte* tracing_level)
        {
            FTloggingAndroidNative.FT_Trace_Set_Level(tracing_level);
        }

        public void FT_Trace_Set_Default_Level()
        {
            FTloggingAndroidNative.FT_Trace_Set_Default_Level();
        }

        public void FT_Set_Log_Handler(delegate* unmanaged<byte*, byte*, byte*, void> * handler)
        {
            FTloggingAndroidNative.FT_Set_Log_Handler(handler);
        }

        public void FT_Set_Default_Log_Handler()
        {
            FTloggingAndroidNative.FT_Set_Default_Log_Handler();
        }

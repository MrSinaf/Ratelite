...
internal class ImageResultFloat
{
	...
	internal static unsafe ImageResultFloat FromResult(
		float* result,
		int width,
		int height,
	...
	public static unsafe ImageResultFloat FromStream(
		Stream stream,
	...
	public static ImageResultFloat FromMemory(
		byte[] data,
		ColorComponents requiredComponents = ColorComponents.Default
	)
	{
